                  ...
                  <table id="crud" class="table table-striped table-hover text-center" style="width:100%">
                    ...
                    <?php while ($puesto = $puestos->fetch_object()):?>
                        <tr>
                            ...
                            <td><?=$puesto->depnombre?></td>
                            <td><?=$puesto->nombrepuesto?></td>
                            <td><?=substr($puesto->descripcion, 0, 30) . ""?></td>
                            <td>
                            <?php if($puesto->idstatus == 1):?>
                            <span class="badge bg-green">Activo</span>
                            <?php elseif($puesto->idstatus == 2):?>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="<?=baseUrl?>?controller=competecnica&action=competenciasTecnicasPuesto&id=<?=$puesto->idpuesto?>"><i class="fa fa-fw fa-trophy"></i> Competencias Tecnicas</a>
