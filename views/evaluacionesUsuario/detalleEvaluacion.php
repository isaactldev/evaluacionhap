    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-6 col-sm-6 text-center">
          <h1>DETALLE DE LA EVALUACIÓN DEL DESEMPEÑO <?php echo $date = date("Y"); ?> - PERSONAL OPERATIVO</h1>
        </div>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="d-grid gap-2 d-md-flex mb-2 justify-content-md-end">
                <table id="examen" class="table table-hover table-responsive text-center mb-5" style="width: auto">
                    ...
                    <?php while ($pregunta = $cuestionarioUsuario->fetch_object()) : ?>
                      <tr>
                        ...
                        <td>
                          ...
                          ?>
                          <p><?= strtoupper($pregunta->pregunta) ?> </p>
                        </td>
                        <!-- /PREGUNTA -->
                        <?php
      ...
      for (let i = 0; i < totalPreguntasTec; i++) {
        ...
        if (isNaN(valorRTec)) {
          Swal.fire({
            ...
            text: "Una de las Preguntas esta aun sin responder porfavor verificalo!",
            allowOutsideClick: false,
            allowEnterKey: false,
            allowEscapeKey: false,
            timer: 3500
