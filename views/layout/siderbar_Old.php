      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($_SESSION['admin']) : ?>
          ...
          <?php if ($_SESSION['identity']->rol == 'admin' || $_SESSION['identity']->rol == 'user') : ?>
            ...
            $sqlexistUserEvaluador360 = "SELECT * FROM `personal360` WHERE idevaluador = {$_SESSION['identity']->noempleado} AND statuseva360 = 2 ;";/* AND fecha = {$yearActual};"; */
          ...
          <?php if ($_SESSION['identity']->rol == 'admin' || $_SESSION['identity']->rol == 'user') : ?>
            ...
            $sqlexistUserEvaluador360 = "SELECT per360.idevaluador, per360.idevaluado, calif360.idperiodo, per360.tipoevaluador, calif360.fecha, us.idusuario, us.appaterno, us.apmaterno, us.nombreuser FROM `personal360` per360 
            INNER JOIN usuarios us ON per360.idevaluado = us.noempleado 
            INNER JOIN calificacion360 calif360 ON calif360.idusuario = us.idusuario 
            WHERE per360.idevaluador = {$_SESSION['identity']->noempleado} AND calif360.idstatus = 1 AND calif360.fecha = {$yearActual} AND calif360.idperiodo = {$periodo->idperiodo} AND per360.tipoevaluador LIKE '%JEFE INMEDIATO%';";
            //echo $sqlexistUserEvaluador360;
            $existUserEvaluador360 = mysqli_query($db360, $sqlexistUserEvaluador360);
            ?>
